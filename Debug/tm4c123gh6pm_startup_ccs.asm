...
;* Date/Time created: Wed Feb 10 23:08:38 2016                                *
;******************************************************************************
...
$C$DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("Timer0ISR")
	.dwattr $C$DW$1, DW_AT_TI_symbol_name("Timer0ISR")
...
$C$DW$2	.dwtag  DW_TAG_subprogram, DW_AT_name("Timer1ISR")
	.dwattr $C$DW$2, DW_AT_TI_symbol_name("Timer1ISR")
...
$C$DW$3	.dwtag  DW_TAG_subprogram, DW_AT_name("UART1IntHandler")
	.dwattr $C$DW$3, DW_AT_TI_symbol_name("UART1IntHandler")
...
$C$DW$4	.dwtag  DW_TAG_subprogram, DW_AT_name("IntGPIOd")
	.dwattr $C$DW$4, DW_AT_TI_symbol_name("IntGPIOd")
...
$C$DW$5	.dwtag  DW_TAG_subprogram, DW_AT_name("Timer4ISR")
	.dwattr $C$DW$5, DW_AT_TI_symbol_name("Timer4ISR")
...
g_pfnVectors:
	...
	.bits	Timer0ISR,32		; g_pfnVectors[35] @ 1120
	.bits	IntDefaultHandler,32		; g_pfnVectors[36] @ 1152
	.bits	Timer1ISR,32		; g_pfnVectors[37] @ 1184
	...
	.bits	Timer4ISR,32		; g_pfnVectors[86] @ 2752
...
;	C:\ti6\ccsv6\tools\compiler\arm_5.1.6\bin\armacpia.exe -@C:\\Users\\massimo\\AppData\\Local\\Temp\\1094812 
	.sect	".text"
	.clink
	.thumbfunc ResetISR
	.thumb
...
$C$DW$8	.dwtag  DW_TAG_subprogram, DW_AT_name("ResetISR")
	...
	.dwattr $C$DW$8, DW_AT_TI_begin_line(0xf6)
	.dwattr $C$DW$8, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$8, DW_AT_decl_file("../tm4c123gh6pm_startup_ccs.c")
	.dwattr $C$DW$8, DW_AT_decl_line(0xf6)
	.dwattr $C$DW$8, DW_AT_decl_column(0x01)
	.dwattr $C$DW$8, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../tm4c123gh6pm_startup_ccs.c",line 247,column 1,is_stmt,address ResetISR,isa 1

	.dwfde $C$DW$CIE, ResetISR
;----------------------------------------------------------------------
; 246 | ResetISR(void)                                                         
; 248 | //                                                                     
; 249 | // Jump to the CCS C initialization routine.  This will enable the     
; 250 | // floating-point unit as well, so that does not need to be done here. 
; 251 | //                                                                     
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../tm4c123gh6pm_startup_ccs.c",line 252,column 5,is_stmt,isa 1
;----------------------------------------------------------------------
; 252 | __asm("    .global _c_int00\n"                                         
; 253 |       "    b.w     _c_int00");                                         
;----------------------------------------------------------------------
    .global _c_int00
    b.w     _c_int00
	.dwpsn	file "../tm4c123gh6pm_startup_ccs.c",line 254,column 1,is_stmt,isa 1
...
$C$DW$10	.dwtag  DW_TAG_subprogram, DW_AT_name("NmiSR")
	...
	.dwattr $C$DW$10, DW_AT_TI_begin_line(0x108)
	.dwattr $C$DW$10, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$10, DW_AT_decl_file("../tm4c123gh6pm_startup_ccs.c")
	.dwattr $C$DW$10, DW_AT_decl_line(0x108)
	.dwattr $C$DW$10, DW_AT_decl_column(0x01)
	.dwattr $C$DW$10, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../tm4c123gh6pm_startup_ccs.c",line 265,column 1,is_stmt,address NmiSR,isa 1

	.dwfde $C$DW$CIE, NmiSR
;----------------------------------------------------------------------
; 264 | NmiSR(void)                                                            
; 266 | //                                                                     
; 267 | // Enter an infinite loop.                                             
; 268 | //                                                                     
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../tm4c123gh6pm_startup_ccs.c",line 269,column 11,is_stmt,isa 1
;----------------------------------------------------------------------
; 269 | while(1)                                                               
;----------------------------------------------------------------------
;* --------------------------------------------------------------------------*
...
;* --------------------------------------------------------------------------*
||$C$L1||:    
        B         ||$C$L1||             ; [DPU_3_PIPE] |269| 
        ; BRANCH OCCURS {||$C$L1||}      ; [] |269| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$10, DW_AT_TI_end_file("../tm4c123gh6pm_startup_ccs.c")
	.dwattr $C$DW$10, DW_AT_TI_end_line(0x110)
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../tm4c123gh6pm_startup_ccs.c",line 287,column 11,is_stmt,isa 1
;----------------------------------------------------------------------
; 287 | while(1)                                                               
;----------------------------------------------------------------------
;* --------------------------------------------------------------------------*
...
;* --------------------------------------------------------------------------*
||$C$L2||:    
        B         ||$C$L2||             ; [DPU_3_PIPE] |287| 
        ; BRANCH OCCURS {||$C$L2||}      ; [] |287| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$11, DW_AT_TI_end_file("../tm4c123gh6pm_startup_ccs.c")
	.dwattr $C$DW$11, DW_AT_TI_end_line(0x122)
...
$C$DW$12	.dwtag  DW_TAG_subprogram, DW_AT_name("IntDefaultHandler")
	...
	.dwattr $C$DW$12, DW_AT_TI_begin_line(0x12c)
	.dwattr $C$DW$12, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$12, DW_AT_decl_file("../tm4c123gh6pm_startup_ccs.c")
	.dwattr $C$DW$12, DW_AT_decl_line(0x12c)
	.dwattr $C$DW$12, DW_AT_decl_column(0x01)
	.dwattr $C$DW$12, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../tm4c123gh6pm_startup_ccs.c",line 301,column 1,is_stmt,address IntDefaultHandler,isa 1

	.dwfde $C$DW$CIE, IntDefaultHandler
;----------------------------------------------------------------------
; 300 | IntDefaultHandler(void)                                                
; 302 | //                                                                     
; 303 | // Go into an infinite loop.                                           
; 304 | //                                                                     
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../tm4c123gh6pm_startup_ccs.c",line 305,column 11,is_stmt,isa 1
;----------------------------------------------------------------------
; 305 | while(1)                                                               
;----------------------------------------------------------------------
;* --------------------------------------------------------------------------*
...
;* --------------------------------------------------------------------------*
||$C$L3||:    
        B         ||$C$L3||             ; [DPU_3_PIPE] |305| 
        ; BRANCH OCCURS {||$C$L3||}      ; [] |305| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$12, DW_AT_TI_end_file("../tm4c123gh6pm_startup_ccs.c")
	.dwattr $C$DW$12, DW_AT_TI_end_line(0x134)
...
$C$DW$T$25	.dwtag  DW_TAG_typedef, DW_AT_name("uint8_t")
	...
	.dwattr $C$DW$T$25, DW_AT_decl_file("C:/ti6/ccsv6/tools/compiler/arm_5.1.6/include/stdint.h")
...
$C$DW$T$54	.dwtag  DW_TAG_typedef, DW_AT_name("__builtin_va_list")
	...
	.dwattr $C$DW$T$54, DW_AT_decl_line(0x134)
